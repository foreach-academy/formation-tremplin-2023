-- Insère des données dans la table réalisateurs
...
-- Insère des données dans la table acteurs
...
-- Insère des données dans la table films
...
-- Insère des données dans la table movie_revenues
...
-- Insère des donnnées dans la table movies_actors
